...
const Footer = () => {
  return (
    <div id='contact' className='w-full h-96 bg-green-700 flex justify-center items-center flex-col gap-3'>
      ...
      <Link href='mailto:christian.wiss@optimaedu.fi'><h3 className='text-slate-50 text-xl'>Contact me here:</h3></Link>
      <Link href='https://github.com/zer0cheros/zer0cheros.fi'><h3 className='text-slate-50 text-lg'>Source code</h3></Link>
