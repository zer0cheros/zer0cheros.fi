...
function Card({ id, back, front}:CardType) {
  ...
  return (
    ...
    key={id}
      ...
      onClick={handleClick}>  
      <motion.div transition={{duration: 1}} className={`bg-cover bg-no-repeat max-md:bg-right rounded-md shadow-lg w-full h-full text-center flex justify-between flex-col p-5 ${show? front: back}`} >
        {!show ? 
        <div >
        <div className='h-full'>
          <h1 className=' md:text-3xl text-xl p-3 text-center text-green-700' >Zer0cheros</h1>
            <p className='md:text-2xl text-slate-50 text-sm p-3 text-justify'>Programming teacher from Kokkola, Finland. Creating and sharing knowledge is my passion.
