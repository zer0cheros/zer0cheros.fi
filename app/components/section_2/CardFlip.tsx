          ...
          <h1 className=' md:text-3xl text-xl p-3 text-center text-green-700' >Zer0cheros</h1>
            ...
            <ul className='flex flex-wrap md:p-4 p-1 md:gap-6 gap-2 w-full h-full items-center justify-center text-center'>
              ...
              <li className="w-auto h-12">
                ...
                <div>
              <h1 className='md:text-3xl text-lg p-4 md:mt-5 text-center text-green-700' >Backend</h1>
              ...
              <div>
              <h1 className='md:text-3xl text-lg md:p-4 p-2 md:mt-5 text-center text-green-700' >Dev-Ops</h1>
              <ul className='flex flex-wrap md:p-3 p-3 md:gap-6 gap-2 w-full h-full items-center justify-center text-center'>
              <li className="w-auto h-12">
