...
export default function InfoText() {
  return (
    <motion.div initial={{x:200 , opacity: 0}} animate={{x: 0, opacity: 1}} transition={{duration: 1, delay:2}} className='absolute z-50 right-10 min-[2000px]:bottom-64 bottom-36 '>
